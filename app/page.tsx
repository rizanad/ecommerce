          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-20">
            ...
            <div className="lg:col-span-2 space-y-6 text-sm font-bold text-slate-400">
               ...
               <ul className="space-y-4">
                 ...
                 <li><Link href="/new" className="hover:text-violet-600">New Arrivals</Link></li>
               </ul>
            </div>
            ...
            <div className="lg:col-span-2 space-y-6 text-sm font-bold text-slate-400">
               ...
               <ul className="space-y-4">
                 <li><Link href="/contact" className="hover:text-violet-600">Help Center</Link></li>
                 <li><Link href="/returns" className="hover:text-violet-600">Shipping & Returns</Link></li>
               </ul>
            </div>
